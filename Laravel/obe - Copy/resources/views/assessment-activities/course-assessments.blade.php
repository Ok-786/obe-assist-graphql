...
<html lang="en">
  ...
  <body>
    <center><h3>Course Assessments for {{ $course_id }}</h3></center>
        ...
        <table class="table table-striped" id="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href={{ route ('assessment-activities.create', ['course_id' => $course_id, 'course_assessment_id' => $val->course_assessment_id]) }}>{{$assessment_type}}</a></td>
                    <td>{{$course_title}}</td>
                    <td>
